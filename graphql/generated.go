...
func (ec *executionContext) _Query_me(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *User) graphql.Marshaler {
			return ec.marshalNUser2ᚖgithubᚗcomᚋMorningBlossomᚋauthᚑserviceᚋinternalᚋgraphqlᚐUser(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_User(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *User) graphql.Marshaler {
			return ec.marshalOUser2ᚖgithubᚗcomᚋMorningBlossomᚋauthᚑserviceᚋinternalᚋgraphqlᚐUser(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) marshalNUser2ᚖgithubᚗcomᚋMorningBlossomᚋauthᚑserviceᚋinternalᚋgraphqlᚐUser(ctx context.Context, sel ast.SelectionSet, v *User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOUser2ᚖgithubᚗcomᚋMorningBlossomᚋauthᚑserviceᚋinternalᚋgraphqlᚐUser(ctx context.Context, sel ast.SelectionSet, v *User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._User(ctx, sel, v)
